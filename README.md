...
C:\Users\Ainal Aiman\Documents\SIT-System\backend\.venv\Scripts\python.exe -m uvicorn ...

# CORRECT – wrap the path in quotes
& "C:\Users\Ainal Aiman\Documents\SIT-System\backend\.venv\Scripts\python.exe" -m uvicorn ...

# CORRECT – use Set-Location -LiteralPath
Set-Location -LiteralPath "C:\Users\Ainal Aiman\Documents\SIT-System\backend"
```
